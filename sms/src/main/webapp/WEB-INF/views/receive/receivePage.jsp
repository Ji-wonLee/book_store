...
<body>
	...
	<section>
		<div class="max-w-4xl mx-auto">
			...
			<div class="input">
				<button style="border-radius: 3px; width: 150px; height: 40px; background-color : #c2c2d6;" type="submit">재고반영</button>
			</div>
				<div class="insert">
					<p style="margin:'3px';">${rdList[0].receive_id} 총액 : ${totalprice}</p><br> 
					<input type="hidden"
