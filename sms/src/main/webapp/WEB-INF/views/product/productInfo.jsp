...
<body>
    ...
    <section>
        <div class="max-w-4xl mx-auto">
            <form id="stateCheck" action="/sms/addItemtoCart" method="GET">
                <div class="productInfo">
                    ...
                    <div class="input">
                        <input style="border-radius: 3px; width: 150px; height: 40px; background-color : #c2c2d6;" type="submit" id="addCart" value="장바구니 추가" onclick="getCart(event)">
                    </div>
                </div>
            </form>
        </div>
